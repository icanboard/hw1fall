...
CREATE TABLE dbo.ARTWORKS (
	...
	CONSTRAINT[FK_dbo.ARTWORKS.ARTISTS] FOREIGN KEY (AID)
...
CREATE TABLE dbo.CLASSIFICATIONS (
	...
	CONSTRAINT[FK.dbo_ARTWORKS_CLASSIFICATIONS] FOREIGN KEY (AWID)
		REFERENCES dbo.ARTWORKS (AWID)
		ON DELETE CASCADE
		ON UPDATE CASCADE,
	CONSTRAINT[FK.dbo_GENRES_CLASSIFICATIONS] FOREIGN KEY (Genre)
